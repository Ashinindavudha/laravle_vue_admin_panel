        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h4 class="card-title">Create ကာရကကျမ်းရင်းပါဠိ</h4>
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  >
                    <label class="bmd-label-floating">သဒ္ဒါအခန်းရွေးပါ</label>
                    <v-select
                      name="chapter"
                      label="title"
                      :key="'chapter-field'"
...
export default {
  ...
  computed: {
    ...mapGetters('KarakasSingle', ['entry', 'loading', 'lists'])
  },
  mounted() {
  ...
  methods: {
    ...
    submitForm() {
      this.storeData()
        .then(() => {
          this.$router.push({ name: 'karakas.index' })
