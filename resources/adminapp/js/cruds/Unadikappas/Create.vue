        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h4 class="card-title">Create ဥဏာဒ်ကျမ်းရင်းပါဠိ</h4>
            </div>
            <div class="card-body">
...
export default {
  ...
  computed: {
    ...mapGetters('UnadikappasSingle', ['entry', 'loading', 'lists'])
  },
  mounted() {
  ...
  methods: {
    ...
    submitForm() {
      this.storeData()
        .then(() => {
          this.$router.push({ name: 'unadikappas.index' })
